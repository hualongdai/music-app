  ...
  <div class="player" v-show="playList.length > 0">
      ...
      <div class="normal-player" v-show="fullScreen">
          ...
          <scroll class="middle-r" :data="currentLyric && currentLyric.lines" ref="lyricList">
            <div class="lyric-wrapper">
              <div v-if="currentLyric">
                <p ref="lyricLine" :class="{ 'current': currentLyricLineNo === index }" class="text" v-for="(line,index) in currentLyric.lines" :key="index">
                  {{line.txt}}
                </p>
              </div>
            </div>
        ...
        <div class="bottom">
          ...
          <div class="operators">
            ...
            <div class="icon i-left" :class="disableClassName">
              <i class="icon icon-prev" @click="prev"></i>
            </div>
            <div class="icon i-center" :class="disableClassName">
              <i class="icon" :class="playIcon" @click="togglePlayState"></i>
            </div>
            <div class="icon i-right" :class="disableClassName">
    ...
    <transition name="mini">
      <div class="mini-player" v-show="!fullScreen" @click="open">
        <div class="icon">
          <img :class="cdClassName" width="40" height="40" :src="currentSong.image">
        </div>
        <div class="text">
...
export default {
  ...
  methods: {
    ...
    enter(el, done) {
      ...
      keyframeAnimate.registerAnimation({
        name: 'move',
        animation,
        presets: {
          duration: 400,
      ...
      keyframeAnimate.runAnimation(this.$refs.cdWrapper, 'move', done)
    },
    afterEnter() {
      keyframeAnimate.unregisterAnimation('move')
    ...
    getLyric() {
      this.currentSong.getLyric().then((data) => {
        if (this.currentSong.lyric !== data) return
    ...
    handleLyric({lineNum, txt}) {
      this.currentLyricLineNo = lineNum
      // 让高亮保持在第五行
      if (lineNum > 5) {
